...
class CartComponent extends Component
{
    ...
    public function destroyAll()
    {
        ...
        session()->flash('success_message', 'Items has been all removed ');
        $this->emitTo('cart-count-component', 'refreshComponent');
    }
    ...
    public function render()
    {
        ...
        $productss = Product::inRandomOrder()->limit(4)->get();
        $products = Product::all();

        return view('livewire.cart-component', ['productss' => $productss, 'products' => $products])->layout('layouts.base');
    }
}
