...
<head>
    ...
    <link rel="stylesheet"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> {{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css" integrity="sha512-mSYUmp1HYZDFaVKK//63EcZq4iFWFjxSL+Z3T/aCt4IO9Cejm03q3NKKYN6pFQzY0SBOr8h+eCIAZHPXcpZaNw==" crossorigin="anonymous" referrerpolicy="no-referrer" /> --}}
...
<body class="home-page home-01 ">
    ...
    <header id="header" class="header header-style-1">
                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: +972599603312" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: +972599603312</a>
                                </li>
                            </ul>
                        </div>
                        <div class="topbar-menu right-menu">
                                    ...
                                    <ul class="submenu lang">
                                        <li class="menu-item"><a title="hungary" href="#"><span
                                                    class="img label-before"><img
                                                        src="{{ asset('assets/images/lang-en.png') }}"
                                                        alt="lang-en"></span>English</a></li>
                                        <li class="menu-item"><a title="arabic" href="#"><span
                                                    class="img label-before"><img
                                                        src="{{ asset('assets/images/ar.png') }}" alt="lang-arabic"
                                                        width="20px"></span>arabic</a></li>
                                ...
                                @if (Route::has('login'))
                                    @auth
                                        @if (Auth::user()->utype == 'ADM')
                                            <li class="menu-item menu-item-has-children parent">
                                                <a title="My Account" href="{{ route('admin.dashboard') }}">My account
                                                ...
                                                <ul class="submenu curency">
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Categories" href="{{ route('admin.products') }}">All
                                                            Products</a>
                                                    </li>
                            ...
                            @else
                                <li class="menu-item menu-item-has-children parent">
                                    <a title="My Account" href="{{ route('user.dashboard') }}">My account
                                        ({{ Auth::user()->name }})<i class="fa fa-angle-down"
                                            aria-hidden="true"></i></a>
                                    <ul class="submenu curency">
                        ...
                        <div class="mid-section main-info-area">
                            ...
                            <div class="wrap-logo-top left-section">
                                <a href="/" class="link-to-home"><img
                                        src="{{ asset('assets/images/fashion.jpg') }}" alt="mercado"
                                        width="100px"></a>
                            </div>
                        ...
                        <div class="primary-nav-section">
                            <div class="container">
                                <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                    ...
                                    <li class="menu-item">
                                        <a href="{{ route('about.us') }}" class="link-term mercado-item-title">About
                                            Us</a>
                                    </li>
                                    <li class="menu-item">
        ...
        {{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/js/bootstrap-datetimepicker.min.js" integrity="sha512-T/tUfKSV1bihCnd+MxKD0Hm1uBBroVYBOYSk1knyvQ9VyZJpc/ALb4P0r6ubwVPSGB2GvjeoMAJJImBG12TiaQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script> --}}
        ...
        <script src="https://cdn.tiny.cloud/1/ef6cstnvzi3sjj22r58e5cynx41t2sgxjkfz9ty2ozdcyty0/tinymce/6/tinymce.min.js"
