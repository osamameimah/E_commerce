                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="sclist">
                                            ...
                                            <li><i class="fa fa-caret-right">{{ $scategory->name }} <a href="{{ route('admin.editcategory',['category_slug'=>$category->slug,'scategory_slug'=>$scategory->slug]) }}" class="slink"> <i class="fa fa-edit"></i></a></i>
