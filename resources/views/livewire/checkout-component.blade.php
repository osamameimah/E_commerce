...
<div class="wrap-address-billing">
                ...
                <p class="row-in-form">
                    ...
                    <p class="row-in-form">
                        <label for="city">Town / City<span>*</span></label>
                        <input  type="text" name="city" value="1" placeholder="City name"wire:model="s_city">
                @error('s_city')
                         <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </p>
...
@endif
         <p class="row-in-form">
                        <label for="cart-no">Cart Number:</label>
                        <input  type="text" name="zip-cart_no" value="" placeholder="Cart Number" wire:model="cart_no">
                     @error('cart_no')
                         <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </p>
                     ...
                     @error('exp_year')
                        ...
                        <input  type="password" name="cvc" value="" placeholder="Cart Number" wire:model="cvc">
                     @error('cvc')
                         <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </p>
