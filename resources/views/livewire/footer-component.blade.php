								...
								<div class="item-content">
									<div class="wrap-list-item social-network">
										<ul>
											...
											<li><a href="{{ $setting->youtube }}" class="link-to-item" title="youtupe"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2022 Osama Meimah. All rights reserved</p>
					</div>
					<div class="coppy-right-item item-right">
						<div class="wrap-nav horizontal-nav">
							<ul>
								...
								<li class="menu-item"><a href="{{ route('terms') }}" class="link-term">Terms & Conditions</a></li>
								<li class="menu-item"><a href="{{ route('policis') }}" class="link-term">Return Policy</a></li>								
							</ul>
						</div>
					</div>
